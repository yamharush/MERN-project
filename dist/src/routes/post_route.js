...
router.get("/", auth_1.default.authenticateMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.query.sender == null) {
        ...
        try {
            const response = yield post_1.default.getPostBySender(request_1.default.fromRestRequest(req), req.query.sender);
            response.sendRestResponse(res);
        }
        catch (err) {
            res.status(400).send({
...
router.get("/:id", auth_1.default.authenticateMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield post_1.default.getPostById(request_1.default.fromRestRequest(req), req.params.id);
        response.sendRestResponse(res);
    }
    catch (err) {
        res.status(400).send({
...
router.put("/:id", auth_1.default.authenticateMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield post_1.default.putPostById(request_1.default.fromRestRequest(req), req.params.id);
        response.sendRestResponse(res);
    }
    catch (err) {
        res.status(400).send({
